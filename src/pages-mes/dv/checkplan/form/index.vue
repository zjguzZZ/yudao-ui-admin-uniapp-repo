    ...
    <view>
      <wd-form ref="formRef" :model="formData" :schema="formSchema">
        <wd-cell-group border>
          ...
          <wd-form-item title="方案类型" title-width="200rpx" prop="type" center>
          ...
          <wd-datetime-picker
            ...
            prop="endDate"
          />
          <wd-form-item title="周期类型" title-width="200rpx" prop="cycleType" center>
            <wd-input-number v-model="formData.cycleType" :min="0" />
          </wd-form-item>
          <wd-form-item title="周期数量" title-width="200rpx" prop="cycleCount" center>
            <wd-input-number v-model="formData.cycleCount" :min="0" />
          </wd-form-item>
...
import { createCheckPlan, updateCheckPlan, getCheckPlan } from '@/api/mes/dv/checkplan'
