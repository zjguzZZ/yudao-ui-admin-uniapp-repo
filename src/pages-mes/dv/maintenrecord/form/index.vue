    ...
    <view>
      <wd-form ref="formRef" :model="formData" :schema="formSchema">
        <wd-cell-group border>
          <wd-form-item title="计划编号" title-width="200rpx" prop="planId" center>
          ...
          <wd-datetime-picker
            ...
            prop="maintenTime"
          />
          <wd-form-item title="用户编号" title-width="200rpx" prop="userId" center>
            <wd-input-number v-model="formData.userId" :min="0" />
          </wd-form-item>
          <wd-form-item title="保养人名称" title-width="200rpx" prop="nickname">
            <wd-input
...
import { createMaintenRecord, updateMaintenRecord, getMaintenRecord } from '@/api/mes/dv/maintenrecord'
