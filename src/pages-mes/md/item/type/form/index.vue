    ...
    <view>
      <wd-form ref="formRef" :model="formData" :schema="formSchema">
        <wd-cell-group border>
          <wd-form-item title="父分类编号" title-width="200rpx" prop="parentId" center>
            <wd-input-number v-model="formData.parentId" :min="0" />
          </wd-form-item>
          <wd-form-item title="分类编码" title-width="200rpx" prop="code">
            <wd-input
...
import { createItemType, updateItemType, getItemType } from '@/api/mes/md/item/type'
