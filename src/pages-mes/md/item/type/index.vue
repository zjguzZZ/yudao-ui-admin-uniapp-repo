        ...
        >
          <view class="p-24rpx">
            ...
            <view class="mb-12rpx flex items-center text-28rpx text-[#666]">
              <text class="mr-8rpx shrink-0 text-[#999]">分类名称：</text>
...
async function queryList(pageNo: number, pageSize: number) {
  try {
    ...
    const data = await getItemTypeList(params as any)
...
function handleAdd() {
  uni.navigateTo({
    url: '/pages-mes/md/item/type/form/index',
  })
}
...
function handleDetail(item: any) {
  uni.navigateTo({
    url: `/pages-mes/md/item/type/detail/index?id=${(item as any).id}`,
  })
}
