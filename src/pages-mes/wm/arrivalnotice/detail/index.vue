  ...
  <view class="yd-page-container">
    ...
    <view>
      <wd-cell-group border>
        ...
        <wd-cell title="采购订单编号" :value="formatFieldValue(formData?.purchaseOrderCode) || '-'" />
        <wd-cell title="供应商名称" :value="formatFieldValue(formData?.vendorName) || '-'" />
        <wd-cell title="联系人" :value="formatFieldValue(formData?.contactName) || '-'" />
        <wd-cell title="联系方式" :value="formatFieldValue(formData?.contactTelephone) || '-'" />
        <wd-cell title="到货日期" :value="formatFieldValue(formData?.arrivalDate) || '-'" />
    ...
    <view class="yd-detail-footer">
      <view class="yd-detail-footer-actions">
        <wd-button
          v-if="hasAccessByCodes(['mes:wm-arrival-notice:update'])"
          class="flex-1" type="warning" @click="handleEdit"
        >
          编辑
        </wd-button>
        <wd-button
          v-if="hasAccessByCodes(['mes:wm-arrival-notice:delete'])"
...
import { getArrivalNotice, deleteArrivalNotice } from '@/api/mes/wm/arrivalnotice'
...
async function handleDelete() {
  ...
  deleting.value = true
  try {
    await deleteArrivalNotice(props.id)
    toast.success('删除成功')
