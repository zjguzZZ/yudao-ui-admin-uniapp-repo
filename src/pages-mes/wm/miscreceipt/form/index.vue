...
import { createMiscReceipt, updateMiscReceipt, getMiscReceipt } from '@/api/mes/wm/miscreceipt'
...
const getTitle = computed(() => props.id ? '编辑其他入库' : '新增其他入库')
...
async function handleSubmit() {
  ...
  try {
    if (props.id) {
      ...
      await createMiscReceipt(formData.value)
      toast.success('新增成功')
    }
