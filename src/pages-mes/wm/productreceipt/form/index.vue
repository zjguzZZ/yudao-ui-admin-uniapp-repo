...
import { createProductReceipt, updateProductReceipt, getProductReceipt } from '@/api/mes/wm/productreceipt'
...
const getTitle = computed(() => props.id ? '编辑产品入库' : '新增产品入库')
...
async function handleSubmit() {
  ...
  try {
    if (props.id) {
      ...
      await createProductReceipt(formData.value)
      toast.success('新增成功')
    }
