    ...
    <view>
      <wd-form ref="formRef" :model="formData" :schema="formSchema">
        <wd-cell-group border>
          ...
          <wd-form-item title="vendorNickname" title-width="200rpx" prop="vendorNickname">
            <wd-input
              v-model="formData.vendorNickname"
              clearable
              placeholder="请输入vendorNickname"
            />
          </wd-form-item>
          <wd-datetime-picker
            ...
            prop="returnDate"
          />
          <wd-form-item title="returnReason" title-width="200rpx" prop="returnReason">
            <wd-input
              v-model="formData.returnReason"
              clearable
              placeholder="请输入returnReason"
            />
          </wd-form-item>
          <wd-form-item title="transportCode" title-width="200rpx" prop="transportCode">
            <wd-input
              v-model="formData.transportCode"
              clearable
              placeholder="请输入transportCode"
            />
          </wd-form-item>
          <wd-form-item title="transportTelephone" title-width="200rpx" prop="transportTelephone">
            <wd-input
              v-model="formData.transportTelephone"
              clearable
              placeholder="请输入transportTelephone"
            />
          </wd-form-item>
...
import { createReturnVendor, updateReturnVendor, getReturnVendor } from '@/api/mes/wm/returnvendor'
...
async function handleSubmit() {
  ...
  try {
    if (props.id) {
      ...
      await createReturnVendor(formData.value)
      toast.success('新增成功')
    }
